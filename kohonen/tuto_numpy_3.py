...
print("=============================================================================")
print(
    "|| Recherche de l'indice du plus grand élément du tableau et calcul de sa  ||\n|| position dans le tablea (par rapport à la taille du tableau)            ||")
print("=============================================================================")
...
print("=============================================================================")
print(
    "|| Attention ce n'est pas une copie mais juste le pointeur vers le tableau ||\n|| qui est recopié                                                         ||")
print("=============================================================================")
print("'t[0,0] = 7'")
t[0, 0] = 7
print("'print t'")
...
print("=============================================================================")
print(
    "|| Diverses opération sur les tableaux. (+,-,*,/,**) sont des opérations   ||\n|| terme à terme, le produit matricielle est numpy.dot                     ||")
print("=============================================================================")
print("'print t+t3'")
print(t + t3)
print("'print t*t3'")
...
print("=============================================================================")
print(
    "|| Pour les opérations sur les tableaux il faut que les dimensions soient  ||\n|| 'cohérentes'                                                            ||")
print("=============================================================================")
print("'print r.shape'")
print(r.shape)
print("'print z.shape'")
...
print("=============================================================================")
print(
    "|| Par contre numpy peut étendre le tableau sur les axes si ils sont       ||\n|| existants (rajout d'un axe à r puis somme avec z)                       ||")
print("=============================================================================")
